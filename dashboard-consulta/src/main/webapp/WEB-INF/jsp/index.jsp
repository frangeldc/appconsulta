                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                	<c:forEach var="consultaUser" items="${consultasPorUsuario}">
                                    <h4 class="small font-weight-bold">${consultaUser.nome} <span
                                            class="float-right">${consultaUser.consultas.size()}</span></h4>
...
<!--                                     </div> -->
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                	<c:forEach var="exameUser" items="${examesPorUsuario}">
                                    <h4 class="small font-weight-bold">${exameUser.nome} <span
                                            class="float-right">${exameUser.exames.size()}</span></h4>
<!--                                     <div class="progress"> -->
