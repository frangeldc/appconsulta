...
public class Fisico extends Exame {
	...
	public Fisico(String laudo, LocalDateTime data, Double preco) {
...
//	private String batimento;
	...
	public String showInfo(){
		return "Informacoes do exame fisico: Preco: R$ "+super.getPreco()+"; pressao: "+pressao+"; peso:"+peso+"; altura: "+altura;
	}
	...
	public String toString() {
		return "Fisico [showInfo()=" + showInfo() + "]";
	}
