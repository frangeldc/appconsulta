...
public class MedicoController {
	...
	public String telaLista(Model model, @SessionAttribute("user") Usuario usuario) {
		if (usuario.getEmail().equals("admin@infnet.edu.br")) {
			model.addAttribute("lista", medicoService.obterLista());
		} else {
	...
	public String incluir(Model model, Medico medico, Endereco endereco, @SessionAttribute("user") Usuario usuario) {
